...
if __name__ == '__main__':
    ...
    run("python train.py --data pulaar.txt --steps 400 --sample_every 100 --eval_interval 100 --batch_size 32 --block_size 128 --n_layer 2 --n_head 2 --n_embd 128")
    ...
    run(f'python eval_loss.py --data pulaar.txt --ckpt "{RUNS}/model_best.pt" --iters 50 --block_size 128')
