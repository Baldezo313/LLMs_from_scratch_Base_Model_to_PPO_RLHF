...
**2. Tiny LLM training loop from scratch**  

**3. Modern architectural upgrades (RoPE, RMSNorm, KV-cache, etc.)**  

**4. Scaling techniques for larger models**  
...
**9. RLHF via GRPO (Group-Relative Policy Optimization)**  
...
**1.** Positional embeddings (learned + sinusoidal)  

**2.** Self-attention from first principles (manual toy example)  

**3.** Single attention head implementation  

**4.** Multi-head attention (splitting, projections, merging)  

**5.** Feed-forward MLP layers (GELU, expansion)  

**6.** Residual connections & LayerNorm (pre-LN)  

**7.** Stacking multiple blocks into a full transformer  

**8.** Causal masking & autoregressive forward pass  
...
Throughout the pipeline, script track:
